...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'article_manager' => 'getArticleManagerService',
            'article_repository' => 'getArticleRepositoryService',
            ...
            'category_manager' => 'getCategoryManagerService',
            'category_repository' => 'getCategoryRepositoryService',
            'code_manager' => 'getCodeManagerService',
            'code_repository' => 'getCodeRepositoryService',
            'comment_manager' => 'getCommentManagerService',
            'comments_repository' => 'getCommentsRepositoryService',
            ...
            'department_manager' => 'getDepartmentManagerService',
            'department_repository' => 'getDepartmentRepositoryService',
            ...
            'task_manager' => 'getTaskManagerService',
            ...
            'video_manager' => 'getVideoManagerService',
            'video_repository' => 'getVideoRepositoryService',
     ...
     *
     * @return \AppBundle\Form\Type\RegistrationFormType A AppBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getAcmeUser_Registration_Form_TypeService()
    {
        return $this->services['acme_user.registration.form.type'] = new \AppBundle\Form\Type\RegistrationFormType();
    }
    ...
    /**
     * Gets the 'article_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\ArticleManager A AppBundle\Entity\Manager\ArticleManager instance.
     */
    protected function getArticleManagerService()
    {
        return $this->services['article_manager'] = new \AppBundle\Entity\Manager\ArticleManager($this->get('article_repository'), $this->get('category_manager'));
    }

    /**
     * Gets the 'article_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\ArticleRepository A AppBundle\Entity\Repository\ArticleRepository instance.
     */
    protected function getArticleRepositoryService()
    {
        return $this->services['article_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Article');
    }
    ...
    /**
     * Gets the 'category_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\CategoryManager A AppBundle\Entity\Manager\CategoryManager instance.
     */
    protected function getCategoryManagerService()
    {
        return $this->services['category_manager'] = new \AppBundle\Entity\Manager\CategoryManager($this->get('category_repository'));
    }

    /**
     * Gets the 'category_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\CategoryRepository A AppBundle\Entity\Repository\CategoryRepository instance.
     */
    ...
    /**
     * Gets the 'code_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\CodeSnippetManager A AppBundle\Entity\Manager\CodeSnippetManager instance.
     */
    protected function getCodeManagerService()
    {
        return $this->services['code_manager'] = new \AppBundle\Entity\Manager\CodeSnippetManager($this->get('code_repository'));
    }

    /**
     * Gets the 'code_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\CodeSnippetRepository A AppBundle\Entity\Repository\CodeSnippetRepository instance.
     */
    protected function getCodeRepositoryService()
    {
        return $this->services['code_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\CodeSnippet');
    }

    /**
     * Gets the 'comment_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\CommentManager A AppBundle\Entity\Manager\CommentManager instance.
     */
    protected function getCommentManagerService()
    {
        return $this->services['comment_manager'] = new \AppBundle\Entity\Manager\CommentManager($this->get('comments_repository'), $this->get('article_manager'));
    }

    /**
     * Gets the 'comments_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\CommentRepository A AppBundle\Entity\Repository\CommentRepository instance.
     */
    protected function getCommentsRepositoryService()
    {
        return $this->services['comments_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Comment');
    }
    ...
    /**
     * Gets the 'department_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\DepartmentManager A AppBundle\Entity\Manager\DepartmentManager instance.
     */
    protected function getDepartmentManagerService()
    {
        return $this->services['department_manager'] = new \AppBundle\Entity\Manager\DepartmentManager($this->get('department_repository'));
    }

    /**
     * Gets the 'department_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\DepartmentRepository A AppBundle\Entity\Repository\DepartmentRepository instance.
     */
    protected function getDepartmentRepositoryService()
    {
        return $this->services['department_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Department');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => 'homepage', 'use_referer' => true, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_manager')), 'main', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $m, 'main', $o, $p, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55be6d7cf03dc', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    /**
     * Gets the 'task_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\TaskManager A AppBundle\Entity\Manager\TaskManager instance.
     */
    protected function getTaskManagerService()
    {
        return $this->services['task_manager'] = new \AppBundle\Entity\Manager\TaskManager($this->get('task_repository'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\TaskRepository A AppBundle\Entity\Repository\TaskRepository instance.
     */
    protected function getTaskRepositoryService()
    {
        return $this->services['task_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Task');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\UserRepository A AppBundle\Entity\Repository\UserRepository instance.
     */
    protected function getUserRepositoryService()
    {
        return $this->services['user_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'video_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Manager\VideoManager A AppBundle\Entity\Manager\VideoManager instance.
     */
    protected function getVideoManagerService()
    {
        return $this->services['video_manager'] = new \AppBundle\Entity\Manager\VideoManager($this->get('video_repository'), $this->get('category_manager'));
    }

    /**
     * Gets the 'video_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\Repository\VideoRepository A AppBundle\Entity\Repository\VideoRepository instance.
     */
    protected function getVideoRepositoryService()
    {
        return $this->services['video_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\Video');
    }
