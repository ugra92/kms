...
--
-- Host: localhost
-- Generation Time: May 31, 2015 at 06:22 PM
...
(1, 35, 'admin', 'admin', 'ugra1992@gmail.com', 'ugra1992@gmail.com', 1, 'tswsilbwmpcsccwgg04scowc0cgw4os', 'nHTH+n7R8ZByVZy8CxquSftUNBwQA617ABrgwgYe74qDagzPaO6ut66MAXGi7U19cJaWXUoNDxZqnetFd/+Jaw==', '2015-05-31 10:48:29', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:10:"ROLE_ADMIN";}', 0, NULL, 'Administrator', 'System Administrator'),
...
--
-- Constraints for table `codesnippet`
--
ALTER TABLE `codesnippet`
  ADD CONSTRAINT `FK_598885BFA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
